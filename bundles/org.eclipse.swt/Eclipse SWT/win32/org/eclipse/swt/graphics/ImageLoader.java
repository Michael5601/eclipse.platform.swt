	    ...
	    try {
	    	...
	    	switch(flag) {
	    		case SWT.IMAGE_DISABLE:
	    			image = rasterizer.rasterizeDisabledSVG(bytes, scalingFactor);
	    			break;
	    		case SWT.IMAGE_GRAY:
	    			image = rasterizer.rasterizeGraySVG(bytes, scalingFactor);
	    			break;
	    		case SWT.IMAGE_COPY:
	    			image = rasterizer.rasterizeSVG(bytes, scalingFactor);
	    			break;
	    	}
